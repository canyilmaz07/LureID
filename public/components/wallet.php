...
<div class="space-y-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow">
        ...
        <div class="text-3xl font-bold mb-4">
            ₺<span id="currentBalance"><?php echo number_format($userData['balance'], 2); ?></span>
        </div>
    </div>

    <!-- Transaction Actions -->
    <div class="grid grid-cols-3 gap-4">
        <a href="components/wallet/deposit.php"
            class="bg-green-500 text-white px-4 py-3 rounded-lg hover:bg-green-600 transition-colors text-center">
            Deposit
        </a>
        <button id="showWithdraw" class="bg-red-500 text-white px-4 py-3 rounded-lg hover:bg-red-600 transition-colors">
            Withdraw
        </button>
    ...
    <div class="bg-white p-6 rounded-lg shadow">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="components/wallet/recent-transactions.php" class="text-blue-500 hover:text-blue-600">View All</a>
        </div>
        <div class="space-y-4">
...
<script>
    $(document).ready(function () {
        ...
        function refreshTransactions() {
            $.get('components/wallet/recent-transactions.php', function (response) {
        ...
        $('input[name="receiver"]').on('input', function () {
            ...
            usernameTimeout = setTimeout(function () {
                $.post('components/wallet/validate-username.php', {
                    username: username
                }).done(function (response) {
                    response = JSON.parse(response);
